  ...
  describe ".vault_attribute" do
    ...
    context 'with additional encrypted field' do
      it 'updates the additional encrypted field using the specified key' do
        ...
        person = Person.new(encryption_key: encryption_key)
        ...
        plaintext = Vault::Rails.decrypt('transit', encryption_key, person.first_name_custom_encrypted, Vault.client, false)
