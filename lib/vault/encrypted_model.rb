...
module Vault
  module EncryptedModel
    ...
    module ClassMethods
      ...
      def vault_attribute(attribute_name, options = {})
        ...
        define_method(attribute_name) do
          unless  __loaded_attributes.include?(attribute_name)
        ...
        define_method("#{attribute_name}=") do |value|
          ...
          # __vault_load_attribute!(attribute_name, self.class.__vault_attributes[attribute_name])
          __loaded_attributes << attribute_name
    ...
    included do
      ...
      def __loaded_attributes
        @__loaded_attributes ||= Set.new
      end
      ...
      def __vault_load_attribute!(attribute, options)
        ...
        return if __loaded_attributes.include?(attribute)
